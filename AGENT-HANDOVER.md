...
### July 29, 2026: Clinic schedule enhancements (pharmacy hours, holidays, doctor day view)
...
- **Deployed:** `3eb3a98` (feature `4df66a6` + em-dash fix) to `dev` / `staging` / `main` + CLI Netlify all three sites.
...
- **Deployed:** `f9a256e` to `dev` / `staging` / `main` + CLI Netlify all three sites.
...
- **Deployed:** `4136610` to `dev` / `staging` / `main` + CLI Netlify all three sites.
...
- **Updated:** Term sheet, valuation, project plan, capabilities companions; sync guard canonical pattern flipped.
...
- **Added:** `/term-sheet` (`term-sheet.html`), Netlify redirects, cross-links from evidence binder, partner letter, valuation, ontario-readiness.
- **Synced:** `TERM-SHEET-SEED-PREFERRED-SHARE.md`, documentation index, companion docs, sync check guards term-sheet links.
