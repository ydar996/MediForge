-- Purpose: Update intake approval RPCs to capture emergency contact details (address & email)
-- and fallback to the patient's address when the emergency address fields are left blank.
...
-- Keep reject function definition identical to prior migration for consistency.
