-- Purpose: Add platform_login rate limit support (temporary 30 min lockout, not permanent)
-- Extends check_rate_limit to handle platform_login type
...
BEGIN
  ...
  -- Check permanent lock (login only, not platform_login)
