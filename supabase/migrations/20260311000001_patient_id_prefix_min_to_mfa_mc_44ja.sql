-- Migration: Patient ID prefix MIN→MFA-MCXXXX for organization MIN-2026-44JA
...
BEGIN
  ...
  WHERE org_code = 'MIN-2026-44JA';

  IF v_org_id IS NULL THEN
    RAISE NOTICE 'Organization with org_code MIN-2026-44JA not found. Skipping migration.';
    RETURN;
  END IF;
...
BEGIN
  ...
  RAISE NOTICE 'MIN->MFA-MC migration completed for org %', v_org_id;
END $$;
